namespace CourseWork86
{
    ...
    public class Figure
    {
        ...
        /// Отражение.
        /// </summary>
        public void Mirror(MouseEventArgs em)
        {
        ...
        /// <summary>
        /// Масштабирование относительно центра фигуры.
        /// </summary>
        ...
        /// </summary>
        /// <param name="mouse">Кол-во прокруток.</param>
        /// <param name="angleBox">Объект для отображения угла поворота.</param>
        public void Rotation(int mouse, TextBox angleBox)
        {
            float alpha = 0;
            if (mouse > 0)
            {
